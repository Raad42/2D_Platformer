...
//loads bricks for level 1 and sets their position
...
//static obstacles 
    ...
    //Add all obstacles to the obstacles vector
   ...
   obstacles.push_back(brick5);
    ...
    //Set sprite scales and positions to create the level design
    ...
    brick5->getSprite().setScale(0.4f, 0.01f);
    brick5->getSprite().setPosition(700, 375);
...
void Levels::LoadLevel2() { //locations are the same as level 1
